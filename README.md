...
Its complete text is also included verbatim at the end of this README, under
["Complete Master Specification (verbatim)"](#complete-master-specification-verbatim),
so nothing in it depends on following the link.
...
## Complete Master Specification (verbatim)

Everything below this point is the complete, verbatim text of
[`docs/ONEVYRT_Deep_Product_Learning_AI_Implementation_Master_Spec.md`](docs/ONEVYRT_Deep_Product_Learning_AI_Implementation_Master_Spec.md),
included here in full so this README is self-contained. It is not a summary or a rewrite -
the same document is also kept as its own standalone file at the path above, since other
documentation and tooling may reference it there; the two are kept identical.
