...
export const DELETE = withRouteLogging("api/settings/webhooks/[id]:DELETE", async (req: Request, ctx: { params: Promise<{ id: string }> }): Promise<Response> => {
